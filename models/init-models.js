...
function initModels(sequelizeConn) {
  ...
  const CellsXBibliographicReference = _CellsXBibliographicReference.init(sequelizeConn, DataTypes);
  ...
  const CharacterRuleAction = _CharacterRuleAction.init(sequelizeConn, DataTypes);
  ...
  const CharactersXBibliographicReference = _CharactersXBibliographicReference.init(sequelizeConn, DataTypes);
  const CharactersXMedium = _CharactersXMedium.init(sequelizeConn, DataTypes);
  const CharactersXPartition = _CharactersXPartition.init(sequelizeConn, DataTypes);
  ...
  const CuratorPotentialProject = _CuratorPotentialProject.init(sequelizeConn, DataTypes);
  ...
  const InstitutionsXProject = _InstitutionsXProject.init(sequelizeConn, DataTypes);
  const InstitutionsXUser = _InstitutionsXUser.init(sequelizeConn, DataTypes);
  const Matrix = _Matrix.init(sequelizeConn, DataTypes);
  const MatrixAdditionalBlock = _MatrixAdditionalBlock.init(sequelizeConn, DataTypes);
  const MatrixCharacterOrder = _MatrixCharacterOrder.init(sequelizeConn, DataTypes);
  ...
  const MediaFilesXBibliographicReference = _MediaFilesXBibliographicReference.init(sequelizeConn, DataTypes);
  const MediaFilesXDocument = _MediaFilesXDocument.init(sequelizeConn, DataTypes);
  ...
  const ProjectDocumentFolder = _ProjectDocumentFolder.init(sequelizeConn, DataTypes);
  const ProjectDocument = _ProjectDocument.init(sequelizeConn, DataTypes);
  const ProjectDuplicationRequest = _ProjectDuplicationRequest.init(sequelizeConn, DataTypes);
  ...
  const ProjectMembersXGroup = _ProjectMembersXGroup.init(sequelizeConn, DataTypes);
  ...
  BibliographicAuthor.belongsTo(BibliographicReference, { as: "reference", foreignKey: "reference_id"});
  BibliographicReference.hasMany(BibliographicAuthor, { as: "bibliographic_authors", foreignKey: "reference_id"});
  CellsXBibliographicReference.belongsTo(BibliographicReference, { as: "reference", foreignKey: "reference_id"});
  BibliographicReference.hasMany(CellsXBibliographicReference, { as: "cells_x_bibliographic_references", foreignKey: "reference_id"});
  CharactersXBibliographicReference.belongsTo(BibliographicReference, { as: "reference", foreignKey: "reference_id"});
  BibliographicReference.hasMany(CharactersXBibliographicReference, { as: "characters_x_bibliographic_references", foreignKey: "reference_id"});
  MediaFilesXBibliographicReference.belongsTo(BibliographicReference, { as: "reference", foreignKey: "reference_id"});
  BibliographicReference.hasMany(MediaFilesXBibliographicReference, { as: "media_files_x_bibliographic_references", foreignKey: "reference_id"});
  SpecimensXBibliographicReference.belongsTo(BibliographicReference, { as: "reference", foreignKey: "reference_id"});
  ...
  CharacterRuleAction.belongsTo(CharacterState, { as: "state", foreignKey: "state_id"});
  CharacterState.hasMany(CharacterRuleAction, { as: "character_rule_actions", foreignKey: "state_id"});
  CharacterRule.belongsTo(CharacterState, { as: "state", foreignKey: "state_id"});
  CharacterState.hasMany(CharacterRule, { as: "character_rules", foreignKey: "state_id"});
  CharactersXMedium.belongsTo(CharacterState, { as: "state", foreignKey: "state_id"});
  CharacterState.hasMany(CharactersXMedium, { as: "characters_x_media", foreignKey: "state_id"});
  CellNote.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(CellNote, { as: "cell_notes", foreignKey: "character_id"});
  Cell.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(Cell, { as: "cells", foreignKey: "character_id"});
  CellsXBibliographicReference.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(CellsXBibliographicReference, { as: "cells_x_bibliographic_references", foreignKey: "character_id"});
  CellsXMedium.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(CellsXMedium, { as: "cells_x_media", foreignKey: "character_id"});
  CharacterRuleAction.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(CharacterRuleAction, { as: "character_rule_actions", foreignKey: "character_id"});
  CharacterRule.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(CharacterRule, { as: "character_rules", foreignKey: "character_id"});
  CharacterState.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(CharacterState, { as: "character_states", foreignKey: "character_id"});
  CharactersXBibliographicReference.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(CharactersXBibliographicReference, { as: "characters_x_bibliographic_references", foreignKey: "character_id"});
  CharactersXMedium.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(CharactersXMedium, { as: "characters_x_media", foreignKey: "character_id"});
  CharactersXPartition.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(CharactersXPartition, { as: "characters_x_partitions", foreignKey: "character_id"});
  MatrixCharacterOrder.belongsTo(Character, { as: "character", foreignKey: "character_id"});
  Character.hasMany(MatrixCharacterOrder, { as: "matrix_character_orders", foreignKey: "character_id"});
  FoliosXMediaFile.belongsTo(Folio, { as: "folio", foreignKey: "folio_id"});
  Folio.hasMany(FoliosXMediaFile, { as: "folios_x_media_files", foreignKey: "folio_id"});
  InstitutionsXProject.belongsTo(Institution, { as: "institution", foreignKey: "institution_id"});
  Institution.hasMany(InstitutionsXProject, { as: "institutions_x_projects", foreignKey: "institution_id"});
  InstitutionsXUser.belongsTo(Institution, { as: "institution", foreignKey: "institution_id"});
  Institution.hasMany(InstitutionsXUser, { as: "institutions_x_users", foreignKey: "institution_id"});
  ...
  CellsXBibliographicReference.belongsTo(Matrix, { as: "matrix", foreignKey: "matrix_id"});
  Matrix.hasMany(CellsXBibliographicReference, { as: "cells_x_bibliographic_references", foreignKey: "matrix_id"});
  CellsXMedium.belongsTo(Matrix, { as: "matrix", foreignKey: "matrix_id"});
  Matrix.hasMany(CellsXMedium, { as: "cells_x_media", foreignKey: "matrix_id"});
  CharacterOrdering.belongsTo(Matrix, { as: "matrix", foreignKey: "matrix_id"});
  Matrix.hasMany(CharacterOrdering, { as: "character_orderings", foreignKey: "matrix_id"});
  CipresRequest.belongsTo(Matrix, { as: "matrix", foreignKey: "matrix_id"});
  Matrix.hasMany(CipresRequest, { as: "cipres_requests", foreignKey: "matrix_id"});
  MatrixAdditionalBlock.belongsTo(Matrix, { as: "matrix", foreignKey: "matrix_id"});
  Matrix.hasMany(MatrixAdditionalBlock, { as: "matrix_additional_blocks", foreignKey: "matrix_id"});
  MatrixCharacterOrder.belongsTo(Matrix, { as: "matrix", foreignKey: "matrix_id"});
  Matrix.hasMany(MatrixCharacterOrder, { as: "matrix_character_orders", foreignKey: "matrix_id"});
  MatrixFileUpload.belongsTo(Matrix, { as: "matrix", foreignKey: "matrix_id"});
  Matrix.hasMany(MatrixFileUpload, { as: "matrix_file_uploads", foreignKey: "matrix_id"});
  MatrixTaxaOrder.belongsTo(Matrix, { as: "matrix", foreignKey: "matrix_id"});
  Matrix.hasMany(MatrixTaxaOrder, { as: "matrix_taxa_orders", foreignKey: "matrix_id"});
  MatrixAdditionalBlock.belongsTo(MatrixFileUpload, { as: "upload", foreignKey: "upload_id"});
  MatrixFileUpload.hasMany(MatrixAdditionalBlock, { as: "matrix_additional_blocks", foreignKey: "upload_id"});
  CellsXMedium.belongsTo(MediaFile, { as: "medium", foreignKey: "media_id"});
  MediaFile.hasMany(CellsXMedium, { as: "cells_x_media", foreignKey: "media_id"});
  CharactersXMedium.belongsTo(MediaFile, { as: "medium", foreignKey: "media_id"});
  MediaFile.hasMany(CharactersXMedium, { as: "characters_x_media", foreignKey: "media_id"});
  FoliosXMediaFile.belongsTo(MediaFile, { as: "medium", foreignKey: "media_id"});
  MediaFile.hasMany(FoliosXMediaFile, { as: "folios_x_media_files", foreignKey: "media_id"});
  MediaFilesXBibliographicReference.belongsTo(MediaFile, { as: "medium", foreignKey: "media_id"});
  MediaFile.hasMany(MediaFilesXBibliographicReference, { as: "media_files_x_bibliographic_references", foreignKey: "media_id"});
  MediaFilesXDocument.belongsTo(MediaFile, { as: "medium", foreignKey: "media_id"});
  MediaFile.hasMany(MediaFilesXDocument, { as: "media_files_x_documents", foreignKey: "media_id"});
  MediaLabel.belongsTo(MediaFile, { as: "medium", foreignKey: "media_id"});
  MediaFile.hasMany(MediaLabel, { as: "media_labels", foreignKey: "media_id"});
  TaxaXMedium.belongsTo(MediaFile, { as: "medium", foreignKey: "media_id"});
  MediaFile.hasMany(TaxaXMedium, { as: "taxa_x_media", foreignKey: "media_id"});
  MediaFile.belongsTo(MediaView, { as: "view", foreignKey: "view_id"});
  MediaView.hasMany(MediaFile, { as: "media_files", foreignKey: "view_id"});
  CharactersXPartition.belongsTo(Partition, { as: "partition", foreignKey: "partition_id"});
  Partition.hasMany(CharactersXPartition, { as: "characters_x_partitions", foreignKey: "partition_id"});
  TaxaXPartition.belongsTo(Partition, { as: "partition", foreignKey: "partition_id"});
  Partition.hasMany(TaxaXPartition, { as: "taxa_x_partitions", foreignKey: "partition_id"});
  ProjectDocument.belongsTo(ProjectDocumentFolder, { as: "folder", foreignKey: "folder_id"});
  ProjectDocumentFolder.hasMany(ProjectDocument, { as: "project_documents", foreignKey: "folder_id"});
  MediaFilesXDocument.belongsTo(ProjectDocument, { as: "document", foreignKey: "document_id"});
  ProjectDocument.hasMany(MediaFilesXDocument, { as: "media_files_x_documents", foreignKey: "document_id"});
  ...
  Specimen.hasMany(MediaFile, { as: "media_files", foreignKey: "specimen_id"});
  SpecimensXBibliographicReference.belongsTo(Specimen, { as: "specimen", foreignKey: "specimen_id"});
